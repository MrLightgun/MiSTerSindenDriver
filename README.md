...
1. Download the `Install_SindenLightgunDriver.sh` script directly to your MiSTer using `curl`:
   ...
   ```shell
   curl -o /media/fat/Scripts/Install_SindenLightgunDriver.sh https://raw.githubusercontent.com/Matt-Retrogamer/MiSTerSindenDriver/main/Install_SindenLightgunDriver.sh
   ```
